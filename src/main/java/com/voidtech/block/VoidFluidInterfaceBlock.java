...
public class VoidFluidInterfaceBlock extends Block implements EntityBlock {
    private final int tier;

    public VoidFluidInterfaceBlock(Properties properties, int tier) {
        super(properties);
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new VoidFluidInterfaceBlockEntity(
                ModBlockEntities.VOID_FLUID_INTERFACE.get(), pos, state, tier);
    }
