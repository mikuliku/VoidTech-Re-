...
public class VoidItemInterfaceBlock extends Block implements EntityBlock {
    private final int tier;

    public VoidItemInterfaceBlock(Properties properties, int tier) {
        super(properties);
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new VoidItemInterfaceBlockEntity(
                ModBlockEntities.VOID_ITEM_INTERFACE.get(), pos, state, tier);
    }
