...
public final class ModItems {
    ...
    public static final RegistryObject<Item> VOID_FRAME = ITEMS.register("void_frame",
            () -> new BlockItem(ModBlocks.VOID_FRAME.get(), new Item.Properties()));
    public static final RegistryObject<Item> REINFORCED_VOID_FRAME = ITEMS.register("reinforced_void_frame",
            () -> new BlockItem(ModBlocks.REINFORCED_VOID_FRAME.get(), new Item.Properties()));
    public static final RegistryObject<Item> VOID_CRYSTAL_ORE = ITEMS.register("void_crystal_ore",
            () -> new BlockItem(ModBlocks.VOID_CRYSTAL_ORE.get(), new Item.Properties()));

    public static final RegistryObject<Item> VOID_CRYSTAL = ITEMS.register("void_crystal", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> VOID_ALLOY = ITEMS.register("void_alloy", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> VOIDIUM_INGOT = ITEMS.register("voidium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> RESONANT_VOID_ALLOY = ITEMS.register("resonant_void_alloy", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> VOID_MINING_MACHINE_T3 = registerMachineItem("void_mining_machine_t3", ModBlocks.VOID_MINING_MACHINE_T3);
    ...
    public static final RegistryObject<Item> VOID_ENERGY_INTERFACE_T3 = registerMachineItem("void_energy_interface_t3", ModBlocks.VOID_ENERGY_INTERFACE_T3);
    public static final RegistryObject<Item> VOID_ENERGY_INTERFACE_T4 = registerMachineItem("void_energy_interface_t4", ModBlocks.VOID_ENERGY_INTERFACE_T4);
    public static final RegistryObject<Item> VOID_ENERGY_INTERFACE_T5 = registerMachineItem("void_energy_interface_t5", ModBlocks.VOID_ENERGY_INTERFACE_T5);
    public static final RegistryObject<Item> VOID_ENERGY_INTERFACE_T6 = registerMachineItem("void_energy_interface_t6", ModBlocks.VOID_ENERGY_INTERFACE_T6);

    public static final RegistryObject<Item> VOID_BUILDING_WAND = ITEMS.register("void_building_wand",
