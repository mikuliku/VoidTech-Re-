...
public final class ModFluids {
    ...
    public static final RegistryObject<net.minecraftforge.fluids.FluidType> VOID_ORIGINAL_TYPE =
            FLUID_TYPES.register("void_original", () -> VoidFluidTypes.PROPERTIES);
    public static final RegistryObject<net.minecraftforge.fluids.FluidType> VOID_IGNITED_TYPE =
            FLUID_TYPES.register("void_ignited", () -> VoidFluidTypes.HOT_PROPERTIES);
    public static final RegistryObject<net.minecraftforge.fluids.FluidType> VOID_METAL_TYPE =
            FLUID_TYPES.register("void_metal_melt", () -> VoidFluidTypes.METAL_PROPERTIES);
    public static final RegistryObject<net.minecraftforge.fluids.FluidType> VOID_ESSENCE_TYPE =
            FLUID_TYPES.register("void_essence", () -> VoidFluidTypes.ESSENCE_PROPERTIES);
    public static final RegistryObject<net.minecraftforge.fluids.FluidType> VOID_ENERGY_TYPE =
            FLUID_TYPES.register("void_energy", () -> VoidFluidTypes.ENERGY_PROPERTIES);
    public static final RegistryObject<net.minecraftforge.fluids.FluidType> VOID_CONCENTRATE_TYPE =
    ...
    private static final ForgeFlowingFluid.Properties VOID_ORIGINAL_PROPERTIES =
            properties(VOID_ORIGINAL_TYPE, VOID_ORIGINAL, VOID_ORIGINAL_FLOWING);
    private static final ForgeFlowingFluid.Properties VOID_IGNITED_PROPERTIES =
            properties(VOID_IGNITED_TYPE, VOID_IGNITED, VOID_IGNITED_FLOWING);
    private static final ForgeFlowingFluid.Properties VOID_METAL_PROPERTIES =
            properties(VOID_METAL_TYPE, VOID_METAL_MELT, VOID_METAL_MELT_FLOWING);
    private static final ForgeFlowingFluid.Properties VOID_ESSENCE_PROPERTIES =
            properties(VOID_ESSENCE_TYPE, VOID_ESSENCE, VOID_ESSENCE_FLOWING);
    private static final ForgeFlowingFluid.Properties VOID_ENERGY_PROPERTIES =
            properties(VOID_ENERGY_TYPE, VOID_ENERGY, VOID_ENERGY_FLOWING);
    private static final ForgeFlowingFluid.Properties VOID_CONCENTRATE_PROPERTIES =
            properties(VOID_CONCENTRATE_TYPE, VOID_CONCENTRATE, VOID_CONCENTRATE_FLOWING);

    public static final RegistryObject<Block> VOID_ORIGINAL_BLOCK =
            fluidBlock(VOID_ORIGINAL);
    public static final RegistryObject<Block> VOID_IGNITED_BLOCK =
            fluidBlock(VOID_IGNITED);
    public static final RegistryObject<Block> VOID_METAL_MELT_BLOCK =
            fluidBlock(VOID_METAL_MELT);
    public static final RegistryObject<Block> VOID_ESSENCE_BLOCK =
            fluidBlock(VOID_ESSENCE);
    public static final RegistryObject<Block> VOID_ENERGY_BLOCK =
            fluidBlock(VOID_ENERGY);
    public static final RegistryObject<Block> VOID_CONCENTRATE_BLOCK =
            fluidBlock(VOID_CONCENTRATE);

    private static ForgeFlowingFluid.Properties properties(
            RegistryObject<net.minecraftforge.fluids.FluidType> type,
    ...
    private static RegistryObject<Block> fluidBlock(
            RegistryObject<? extends ForgeFlowingFluid.Source> source) {
        return FLUID_BLOCKS.register(
                source.getId().getPath(),
                () -> new LiquidBlock(
                        source.get(),
                        BlockBehaviour.Properties.of()
                                .mapColor(MapColor.COLOR_LIGHT_
